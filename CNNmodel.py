...
training_set = train_datagen.flow_from_directory(
    'shapes-dataset-practice/train', target_size=(28, 28), batch_size=1, class_mode='categorical')
#X_images, y_labels = training_set.filenames, training_set.classes
test_set = test_datagen.flow_from_directory(
    'shapes-dataset-practice/test', target_size=(28, 28), batch_size=1, class_mode='categorical')
